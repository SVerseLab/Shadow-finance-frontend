...
export const DEFAULT_META: PageMeta = {
  title: 'ShadowSwap',
  description:
    'The #1 AMM Dex on Core! Earn SHDW through yield farming or win it in the Lottery, then stake it in Dark Pools to earn more tokens! Initial Farm Offerings , NFTs, and more, on a platform you can trust.',
